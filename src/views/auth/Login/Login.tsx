            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Flex fontFamily="Rubik" fontWeight="400" fontSize="0.8em">
                <MxmVerticalAlign variant="">
                  <Text color="white">Belum punya akun? <Link href="/daftar" color={Palette.Cyan}>Daftar</Link></Text>
                  <Spacer />
                  <Text color="white">Lupa kata sandimu? <Link href="/reset" color={Palette.Cyan}>Klik di sini</Link></Text>
                </MxmVerticalAlign>
                <Spacer/>
